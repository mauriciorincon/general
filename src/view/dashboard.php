...
<head>
    <meta charset="UTF-8">
    <title>Dashboard | Login | Secretaria general Login Solicitudes</title>
    ...
    <!-- Base Css Files -->
    <link href="view/assets/libs/jqueryui/ui-lightness/jquery-ui-1.10.4.custom.min.css" rel="stylesheet" />
    <link href="view/assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <link href="view/assets/libs/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <link href="view/assets/libs/fontello/css/fontello.css" rel="stylesheet" />
    <link href="view/assets/libs/animate-css/animate.min.css" rel="stylesheet" />
    <link href="view/assets/libs/nifty-modal/css/component.css" rel="stylesheet" />
    <link href="view/assets/libs/magnific-popup/magnific-popup.css" rel="stylesheet" />
    <link href="view/assets/libs/ios7-switch/ios7-switch.css" rel="stylesheet" />
    <link href="view/assets/libs/pace/pace.css" rel="stylesheet" />
    <link href="view/assets/libs/sortable/sortable-theme-bootstrap.css" rel="stylesheet" />
    <link href="view/assets/libs/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" />
    <link href="view/assets/libs/jquery-icheck/skins/all.css" rel="stylesheet" />
    <!-- Code Highlighter for Demo -->
    <link href="view/assets/libs/prettify/github.css" rel="stylesheet" />

    <!-- Extra CSS Libraries Start -->
    <link href="view/assets/libs/rickshaw/rickshaw.min.css" rel="stylesheet" type="text/css" />
    <link href="view/assets/libs/morrischart/morris.css" rel="stylesheet" type="text/css" />
    <link href="view/assets/libs/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
    <link href="view/assets/libs/jquery-clock/clock.css" rel="stylesheet" type="text/css" />
    <link href="view/assets/libs/bootstrap-calendar/css/bic_calendar.css" rel="stylesheet" type="text/css" />
    <link href="view/assets/libs/sortable/sortable-theme-bootstrap.css" rel="stylesheet" type="text/css" />
    <link href="view/assets/libs/jquery-weather/simpleweather.css" rel="stylesheet" type="text/css" />
    <link href="aview/ssets/libs/bootstrap-xeditable/css/bootstrap-editable.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="shortcut icon" href="view/assets/img/favicon.ico">
    <link rel="apple-touch-icon" href="view/assets/img/apple-touch-icon.png" />
    <link rel="apple-touch-icon" sizes="57x57" href="view/assets/img/apple-touch-icon-57x57.png" />
    <link rel="apple-touch-icon" sizes="72x72" href="view/assets/img/apple-touch-icon-72x72.png" />
    <link rel="apple-touch-icon" sizes="76x76" href="view/assets/img/apple-touch-icon-76x76.png" />
    <link rel="apple-touch-icon" sizes="114x114" href="view/assets/img/apple-touch-icon-114x114.png" />
    <link rel="apple-touch-icon" sizes="120x120" href="view/assets/img/apple-touch-icon-120x120.png" />
    <link rel="apple-touch-icon" sizes="144x144" href="view/assets/img/apple-touch-icon-144x144.png" />
    <link rel="apple-touch-icon" sizes="152x152" href="view/assets/img/apple-touch-icon-152x152.png" />
</head>
...
<body class="fixed-left">
    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            <div class="topbar-left">
                <div class="logo">
                    <h1><a href="#"><img src="view/assets/img/logo.png" alt="Logo"></a></h1>
                </div>
                        ...
                        <ul class="nav navbar-nav navbar-right top-navbar">
                            <li class="dropdown iconify hide-phone">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                        class="fa fa-globe"></i><span class="label label-danger absolute">4</span></a>
                                <ul class="dropdown-menu dropdown-message">
                                    <li class="dropdown-header notif-header"><i class="icon-bell-2"></i> New
                                        Notifications<a class="pull-right" href="#"><i class="fa fa-cog"></i></a></li>
                                    <li class="unread">
                                        <a href="#">
                                    ...
                                    <li class="dropdown-footer">
                                        <div class="btn-group btn-group-justified">
                                            ...
                                            <div class="btn-group">
                                                <a href="#" class="btn btn-sm btn-danger"><i class="icon-trash-3"></i>
                                                    Clear All</a>
                                            </div>
                                            <div class="btn-group">
                            ...
                            <li class="dropdown iconify hide-phone">
                                ...
                                <ul class="dropdown-menu dropdown-message">
                                    <li class="dropdown-header notif-header"><i class="icon-mail-2"></i> New Messages
                                    </li>
                                    <li class="unread">
                                        <a href="#" class="clearfix">
                                            <img src="view/images/users/chat/2.jpg" class="xs-avatar ava-dropdown"
                                                alt="Avatar">
                                    ...
                                    <li class="unread">
                                        <a href="#" class="clearfix">
                                            <img src="view/images/users/chat/1.jpg" class="xs-avatar ava-dropdown"
                                                alt="Avatar">
                                    ...
                                    <li>
                                        <a href="#" class="clearfix">
                                            <img src="view/images/users/chat/3.jpg" class="xs-avatar ava-dropdown"
                                                alt="Avatar">
                            ...
                            <li class="dropdown iconify hide-phone"><a href="#"
                                    onclick="javascript:toggle_fullscreen()"><i class="icon-resize-full-2"></i></a></li>
                            <li class="dropdown topbar-profile">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                                        class="rounded-image topbar-profile-image"><img
                                            src="view/images/users/user-35.jpg"></span>
                                    <strong><?php echo $_SESSION['username'] ?></strong> <i
                                        class="fa fa-caret-down"></i></a>
                ...
                <div class="profile-info">
                    <div class="col-xs-4">
                        <a href="profile.html" class="rounded-image profile-image"><img
                                src="view/images/users/user-100.jpg"></a>
                    </div>
                    <div class="col-xs-8">
                        <div class="profile-text">Bienvenido <b><?php echo $_SESSION['username'] ?></b></div>
                ...
                <div id="sidebar-menu">
                    <ul>
                        <li class='has_sub'><a href='javascript:void(0);'><i
                                    class='icon-home-3'></i><span>Dashboard</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='?controller=user&accion=loginUser'
                                        class='active'><span>Dashboard</span></a></li>
                            </ul>
						</li>
						<li class='has_sub'><a href='javascript:void(0);'><i
                                    class='icon-pencil-3'></i><span>Administrar</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='forms.html'><span>Dependencias</span></a></li>
                                <li><a href='advanced-forms.html'><span>Tarifario</span></a></li>
                                <li><a href='form-wizard.html'><span>Informacion Contratos</span></a></li>
                                <li><a href='form-validation.html'><span>Interventores</span></a></li>
								<li><a href='form-uploads.html'><span>Estados Solicitud</span></a></li>
								<li><a href='form-uploads.html'><span>Estados Factura</span></a></li>
								<li><a href='form-uploads.html'><span>Perfiles</span></a></li>
								<li><a href='form-uploads.html'><span>Lista Documentos</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>UI
                                    Elements</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i
                                    class='icon-pencil-3'></i><span>Forms</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i
                                    class='fa fa-map-marker'></i><span>Maps</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i
                                    class='fa fa-envelope'></i><span>Email</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i
                                    class='icon-chart-line'></i><span>Charts</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i
                                    class='icon-megaphone'></i><span>Extras</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li class='has_sub'><a href='javascript:void(0);'><span>4 Level Menu</span> <span
                                            class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                                    <ul>
                                        <li class='has_sub'><a href='javascript:void(0);'><span>Sub Item - level
                                                    3</span> <span class="pull-right"><i
                                                        class="fa fa-angle-down"></i></span></a>
                                            <ul>
                                                <li><a href='javascript:void(0);'><span>Sub Item - level 4</span></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <li class='has_sub'><a href='javascript:void(0);'><span>Submenu with icons</span> <span
                                            class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                                    <ul>
                                        <li><a href='javascript:void(0);'><i class='fa fa-camera'></i><span>Item with
                                                    icon</span></a></li>
        ...
        <div class="right side-menu">
            <ul class="nav nav-tabs nav-justified" id="right-tabs">
                <li class="active"><a href="#feed" data-toggle="tab" title="Live Feed"><i class="icon-rss-2"></i></a>
                </li>
                                    ...
                                    <div class="panel-body">
                                        <ul class="list-unstyled" id="notification-list">
                                            <li><a href="javascript:;"><span class="icon-wrapper"><i
                                                            class="icon-video"></i></span> 1 Video Uploaded <span
                                            ...
                                            <li><a href="javascript:;"><span class="icon-wrapper"><i
                                                        ...
                                                        class="muted">12 minutes ago</span></a></li>
                                            <li><a href="javascript:;"><span class="icon-wrapper"><i
                                                            class="icon-hourglass-1"></i></span> Deadline for 1 project
                                    ...
                                    <div class="panel-body">
                                        <ul class="list-unstyled" id="inbox-list">
                                            <li><a href="javascript:;"><span class="sender"><i
                                                    ...
                                                    <span class="content">Where are you? I am waiting for 3 hours in the
                                                        restaurant. I ate 3 hamburgers.</span>
                                                </a></li>
                                            <li><a href="javascript:;"><span class="sender">Tyler Durden</span> <span
                                                    ...
                                                    <span class="content">We are crowded here. We need some more soap at
                                                        home. Buy some before you come home.</span>
                                                </a></li>
                                            <li><a href="javascript:;"><span class="sender">John Bonomo</span> <span
                                                    ...
                                                    <span class="content">Hello, I ordered 15 box of viagra for a friend
                                                        of mine but he still hasn't receive them.</span>
                                                </a></li>
                                        </ul>
                                    ...
                                    <div class="panel-body">
                                        <ul class="list-unstyled" id="updates-list">
                                            <li><a href="javascript:;"><span class="icon-wrapper bg-green-1"><i
                                                            class="icon-comment-1"></i></span> <b>David Guetta</b> came
                                                    online <abbr title="15 seconds ago">just now</abbr>.</a></li>
                                            <li><a href="javascript:;"><span class="icon-wrapper bg-red-1"><i
                                                            class="icon-user-3"></i></span> <b>Katy Perry</b> updated
                                                    her profile <abbr title="4 mins ago">4 mins ago</abbr>.</a></li>
                                            <li><a href="javascript:;"><span class="icon-wrapper bg-blue-1"><i
                                                            class="icon-twitter-2"></i></span> <b>4 tweets posted</b>
                                                    with cronjob <abbr title="22 mins ago">22 mins ago</abbr>.</a></li>
                                            <li><a href="javascript:;"><span class="icon-wrapper bg-orange-3"><i
                                                            class="icon-water"></i></span> <b>Adele</b> set fire to the
                                                    rain <abbr title="43 mins ago">43 mins ago</abbr>.</a></li>
                                            <li><a href="javascript:;"><span class="icon-wrapper bg-pink-2"><i
                                                            class="icon-heart-broken"></i></span> <b>Taylor Swift</b>
                                                    learned that you are trouble <abbr title="3 hours ago">3 days
                                                        ago</abbr>.</a></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul class="list-unstyled" id="chat-list">
                                            <li><a href="javascript:;" class="online"><span
                                                        class="chat-user-avatar"><img
                                                            src="view/images/users/chat/1.jpg"></span> <span
                                                        class="chat-user-name">Dorothy Simons</span><span
                                                        class="chat-user-msg">I wish I was a bird in the sky</span></a>
                                            </li>
                                            <li><a href="javascript:;" class="online"><span
                                                        class="chat-user-avatar"><img
                                                            src="view/images/users/chat/2.jpg"></span> <span
                                                        class="chat-user-name">John Malkovich</span><span
                                                        class="chat-user-msg">You were the traitor</span></a></li>
                                            <li><a href="javascript:;" class="online"><span
                                                        class="chat-user-avatar"><img
                                                            src="view/images/users/chat/3.jpg"></span> <span
                                                        class="chat-user-name">Jessica Simons</span><span
                                                        class="chat-user-msg">Where is my mind</span></a></li>
                                            <li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img
                                                            src="view/images/users/chat/4.jpg"></span> <span
                                                        class="chat-user-name">Jack Stallman</span><span
                                                        class="chat-user-msg">Away since 13:32</span></a></li>
                                            <li><a href="javascript:;" class="offline"><span
                                                        class="chat-user-avatar"><img
                                                            src="view/images/users/chat/5.jpg"></span> <span
                                                        class="chat-user-name">Neil Armstrong</span><span
                                                        class="chat-user-msg" title="I am flying to the moon and back">I
                                                        am flying to the moon and back</span></a></li>
                                            <li><a href="javascript:;" class="offline"><span
                                                        class="chat-user-avatar"><img
                                                            src="view/images/users/chat/6.jpg"></span> <span
                                                        class="chat-user-name">Hollywood Studios</span><span
                                        ...
                                        <ul class="list-unstyled" id="chat-list">
                                            ...
                                            <li><a href="javascript:;" class="online"><span
                                                        ...
                                                        title="Eminem - The Monster ft. Rihanna"><i
                                                            class="icon-play"></i> Eminem - The Monster ft.
                                                        Rihanna</span></a></li>
                                            <li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img
                                                            src="view/images/users/chat/4.jpg"></span> <span
                                                        class="chat-user-name">Jack Stallman</span><span
                        ...
                        <div class="widget green-1 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    ...
                                    <h2><span class="animate-number" data-value="25153" data-duration="3000">0</span>
                                    </h2>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        ...
                        <div class="widget darkblue-2 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    ...
                                    <h2><span class="animate-number" data-value="6399" data-duration="3000">0</span>
                                    </h2>
                        ...
                        <div class="widget pink-1 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    ...
                                    <h2>$<span class="animate-number" data-value="70389" data-duration="3000">0</span>
                                    </h2>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        ...
                        <div class="widget lightblue-1 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    ...
                                    <h2><span class="animate-number" data-value="18648" data-duration="3000">0</span>
                                    </h2>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                                ...
                                <div class="row stacked">
                                    <div class="col-sm-5 mini-stats">
                                        ...
                                        <div class="sales-report-data">
                                            <span class="pull-left">Completed Sales</span><span class="pull-right">65 /
                                                174</span>
                                            <div class="progress progress-xs">
                                            ...
                                            <div class="clearfix"></div>
                                            <span class="pull-left">Shipped Products</span><span class="pull-right">418
                                                / 624</span>
                                            <div class="progress progress-xs">
                                ...
                                <div id="todo-app" class="widget">
                                    ...
                                    <div class="widget-content padding-sm">
                                        <ul class="todo-list">
                                            ...
                                            <li>
                                                <span class="check-icon"><input type="checkbox" /></span>
                                                <span class="todo-item">Don't forget to send those reports to
                                                    John</span>
                                                <span class="todo-options pull-right">
                                                    <a href="javascript:;" class="todo-delete"><i
                                                            class="icon-cancel-3"></i></a>
                                            ...
                                            <li class="medium">
                                                <span class="check-icon"><input type="checkbox" /></span>
                                                <span class="todo-item">If you forgot, go back to office to pick them
                                                    up</span>
                                                <span class="todo-options pull-right">
                                                    <a href="javascript:;" class="todo-delete"><i
                                                            class="icon-cancel-3"></i></a>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 portlets">
                        <div id="weather-widget" class="widget">
                            ...
                            <button class="js-geolocation btn btn-sm btn-default" style="display: none;">Use Your
                                Location</button>
                        </div>
                    </div>
                ...
                <footer>
                    ...
                    <div class="footer-links pull-right">
                        <a href="#">About</a><a href="#">Support</a><a href="#">Terms of Service</a><a
                            href="#">Legal</a><a href="#">Help</a><a href="#">Contact Us</a>
                    </div>
                </footer>
                <!-- Footer End -->
            </div>
    ...
    <script src="view/assets/libs/jquery/jquery-1.11.1.min.js"></script>
    <script src="view/assets/libs/bootstrap/js/bootstrap.min.js"></script>
    <script src="view/assets/libs/jqueryui/jquery-ui-1.10.4.custom.min.js"></script>
    <script src="view/assets/libs/jquery-ui-touch/jquery.ui.touch-punch.min.js"></script>
    <script src="view/assets/libs/jquery-detectmobile/detect.js"></script>
    <script src="view/assets/libs/jquery-animate-numbers/jquery.animateNumbers.js"></script>
    <script src="view/assets/libs/ios7-switch/ios7.switch.js"></script>
    <script src="view/assets/libs/fastclick/fastclick.js"></script>
    <script src="view/assets/libs/jquery-blockui/jquery.blockUI.js"></script>
    <script src="view/assets/libs/bootstrap-bootbox/bootbox.min.js"></script>
    <script src="view/assets/libs/jquery-slimscroll/jquery.slimscroll.js"></script>
    <script src="view/assets/libs/jquery-sparkline/jquery-sparkline.js"></script>
    <script src="view/assets/libs/nifty-modal/js/classie.js"></script>
    <script src="view/assets/libs/nifty-modal/js/modalEffects.js"></script>
    <script src="view/assets/libs/sortable/sortable.min.js"></script>
    <script src="view/assets/libs/bootstrap-fileinput/bootstrap.file-input.js"></script>
    <script src="view/assets/libs/bootstrap-select/bootstrap-select.min.js"></script>
    <script src="view/assets/libs/bootstrap-select2/select2.min.js"></script>
    <script src="view/assets/libs/magnific-popup/jquery.magnific-popup.min.js"></script>
    <script src="view/assets/libs/pace/pace.min.js"></script>
    <script src="view/assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
    <script src="view/assets/libs/jquery-icheck/icheck.min.js"></script>

    <!-- Demo Specific JS Libraries -->
    <script src="view/assets/libs/prettify/prettify.js"></script>

    <script src="view/assets/js/init.js"></script>
    <!-- Page Specific JS Libraries -->
    <script src="view/assets/libs/d3/d3.v3.js"></script>
    <script src="view/assets/libs/rickshaw/rickshaw.min.js"></script>
    <script src="view/assets/libs/raphael/raphael-min.js"></script>
    <script src="view/assets/libs/morrischart/morris.min.js"></script>
    <script src="view/assets/libs/jquery-knob/jquery.knob.js"></script>
    <script src="view/assets/libs/jquery-jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="view/assets/libs/jquery-jvectormap/js/jquery-jvectormap-us-aea-en.js"></script>
    <script src="view/assets/libs/jquery-clock/clock.js"></script>
    <script src="view/assets/libs/jquery-easypiechart/jquery.easypiechart.min.js"></script>
    <script src="view/assets/libs/jquery-weather/jquery.simpleWeather-2.6.min.js"></script>
    <script src="view/assets/libs/bootstrap-xeditable/js/bootstrap-editable.min.js"></script>
    <script src="view/assets/libs/bootstrap-calendar/js/bic_calendar.min.js"></script>
    <script src="view/assets/js/apps/calculator.js"></script>
    <script src="view/assets/js/apps/todo.js"></script>
    <script src="view/assets/js/apps/notes.js"></script>
    <script src="view/assets/js/pages/index.js"></script>
</body>
