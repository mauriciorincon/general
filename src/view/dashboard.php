                    ...
                    <ul>
						...
						<li class='has_sub'><a href='javascript:void(0);'><i
                                    class='icon-pencil-3'></i><span>Administrar</span> <span class="pull-right"><i
                                        class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='#' class = "md-trigger" data-modal = "md-fade-in-scale-up"><span>Dependencias</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget green-1 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    <p class="maindata">SOLICITUDES <b>ABIERTAS</b></p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget darkblue-2 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    <p class="maindata">SOLICITUDES <b>CERRADAS</b></p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget pink-1 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    <p class="maindata">TODAS LAS <b>SOLICITUDES</b></p>
                    ...
                    <div class="col-lg-12 portlets">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><i class="icon-chart-pie-1"></i> <strong>Reporte</strong> Solicitudes</h2>
                ...
                <div class="md-modal md-fade-in-scale-up " id="md-fade-in-scale-up">
                    <div class="md-content modal-lg">
                        
                        <div>
                            <?php
                                include_once('view/dependencia.php');
                            ?>
                            <p>
